...
def main():
	st.markdown("<h1 style='text-align: center; border-style: groove; background-color:#D22B2B; font-family:times new roman; font-size:160px bold;'>MEDSEA <br><br> </h1> <h2><bold>Demonstration shown in the paper</h2> <br><br> <h2> MATHEMATICAL EXPRESSIONS IN SOFTWARE ENGINEERING ARTIFACTS</h2> ", unsafe_allow_html=True)
	st.text("")
	st.text("")
