...
def main():
	st.markdown("<p style='text-align: center; border-style: ridge; border-color: #000000; background-color:#D22B2B; color:#ffffff; font-family:times new roman; font-size:larger; background-image: red.jpg;'>MEDSEA <br><br><small>Demonstration shown in the paper</small><br><br> MATHEMATICAL EXPRESSIONS IN SOFTWARE ENGINEERING ARTIFACTS </p>", unsafe_allow_html=True)
	st.text("")
	st.text("")
