...
```
<ul>
<li> Set <b>input_path</b> to the .xlsx file in <b>Bug_data</b> folder. Also, set preprocessing to False if you do not want to remove URLs and collection of black listed words.</li>
