...
def main():
	st.markdown("<h1 style='text-align: center; border-style: ridge; border-color: #000000; background-color:#D22B2B; font-family:times new roman; font-size:25px; background-image: red.jpg;'>MEDSEA <br><br><small>Demonstration shown in the paper</small><br><br> MATHEMATICAL EXPRESSIONS IN SOFTWARE ENGINEERING ARTIFACTS </h1>", unsafe_allow_html=True)
	st.text("")
	st.text("")
	...
	st.markdown("<h2 style='text-align: center; border-style: ridge; font-family:serif; font-size:20px; background-image: url('website/red.jpg')'> TRY IT YOURSELF </h2>", unsafe_allow_html=True)
