...
def main():
	st.markdown("<h1 style='text-align: center; border-style: groove; background-color:#D22B2B; font-family:times new roman; font-size:40px bold;'>ME Finder <br> <small><bold>Demonstration shown in the paper <br> MATHEMATICAL EXPRESSIONS IN SOFTWARE ENGINEERING ARTIFACTS</small></h1>", unsafe_allow_html=True)
	st.text("")
	st.text("")
